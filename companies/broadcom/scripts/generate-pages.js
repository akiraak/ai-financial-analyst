// HTMLページ生成スクリプト（Broadcom用）
// ワークフロー仕様（analyze-and-visualize.md）に基づき、3つのHTMLファイルを生成する
// - docs/broadcom/index.html（ランディングページ）
// - docs/broadcom/quarters/index.html（四半期選択ページ）
// - docs/broadcom/quarters/template.html（四半期詳細テンプレート）
...
const TICKER = 'AVGO';
const SLUG = 'broadcom';
const DESC = 'ネットワーク・ストレージ半導体とインフラソフトウェアの大手。VMware買収でソフトウェア事業を拡大。';
  ...
  <div class="container" id="mainContent">
    ...
    <div class="section">
      ...
      <div class="chart-description">
        <p><span class="label">報告セグメント（2区分）</span>: Broadcomは Semiconductor Solutions（半導体ソリューション）と Infrastructure Software（インフラストラクチャソフトウェア）の2セグメントで報告している。</p>
        <p><span class="label">Semiconductor Solutions:</span> ネットワーキング、ブロードバンド、ワイヤレス通信、ストレージ、産業用など幅広い半導体製品を提供。AI/クラウド向けカスタムASIC・ネットワーキングチップが成長ドライバー。</p>
        <p><span class="label">Infrastructure Software:</span> メインフレーム、分散型、サイバーセキュリティ、FC SAN管理ソフトウェアを提供。2023年11月のVMware買収により大幅に拡大。</p>
      </div>
    </div>
