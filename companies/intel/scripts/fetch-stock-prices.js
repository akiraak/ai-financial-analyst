// Intel四半期末の株価をYahoo Financeから取得するスクリプト
...
/**
 * IntelのFY四半期末日を取得
 * Intel は52/53週会計年度（12月最終土曜日締め）だが、概ね暦年ベース
 * Q1≈3月末, Q2≈6月末, Q3≈9月末, Q4≈12月末
 */
...
async function main() {
  ...
  console.log(`Intel (${TICKER}) 株価取得: ${quarters.length}四半期分\n`);
