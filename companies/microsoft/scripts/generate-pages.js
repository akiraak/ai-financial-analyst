...
const DESC = 'Azure・Microsoft 365・Windowsを擁するクラウド＆ソフトウェア大手。Copilotで全製品にAIを統合。';
  ...
  <div class="container" id="mainContent">
    ...
    <div class="section">
      ...
      <div class="chart-description">
        <p><span class="label">3事業セグメント</span>（プレスリリース・10-Q/10-Kベース）: Productivity and Business Processes（M365, LinkedIn, Dynamics）/ Intelligent Cloud（Azure, Server, Enterprise Services）/ More Personal Computing（Windows, Gaming, Search）。</p>
        <p><span class="label">Microsoftのセグメント構成:</span> 全セグメントで売上高と営業利益が開示されている。なお FY2025（2024年7月期）に一部製品のセグメント間移管が行われた。</p>
      </div>
    </div>
