// 生成されたxlsxの数値検証スクリプト（Microsoft用）
...
// Microsoft — EPS調整不要（2003年以降株式分割なし）
...
// Microsoft は salesAndMarketing + generalAndAdministrative で SGA を算出
function getSGA(d) {
...
async function main() {
  ...
  const ws = wb.getWorksheet('MSFT業績');
